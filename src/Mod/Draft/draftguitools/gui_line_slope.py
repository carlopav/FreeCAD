...
# *                                                                         *
# ***************************************************************************
"""Provides the Draft_Slope command to give a slope to a line.
...
"""
## @package gui_line_slope
# \ingroup DRAFT
# \brief Provides the Draft_Slope command to give a slope to a line.
...
class Draft_Slope(gui_base.GuiCommandNeedsSelection):
    """GuiCommand for the Draft_Slope tool.
...
Gui.addCommand('Draft_Slope', Draft_Slope())
