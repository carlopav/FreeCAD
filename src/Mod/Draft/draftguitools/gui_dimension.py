...
# *                                                                         *
# ***************************************************************************
"""Provides the Draft dimension commands."""
## @package gui_dimension
# \ingroup DRAFT
# \brief Provides the Draft dimension commands.
...
class Draft_FlipDimension(gui_base.GuiCommandNeedsSelection):
...
Gui.addCommand('Draft_FlipDimension', Draft_FlipDimension())
